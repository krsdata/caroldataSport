...
$route['analysis'] = 'pages/analysis';
$route['nba'] = 'pages/nba_game';
$route['nfl'] = 'pages/nfl_game';
$route['mlb'] = 'pages/mlb_game';
$route['setting'] = 'pages/setting';
$route['how-it-works'] = 'pages/how_it_works';
$route['sports-swaps'] = 'pages/sports_swaps';
$route['comment'] = 'pages/comment_method';
