								 ...
								 <div aria-multiselectable="true" role="tablist" id="accordion2" class="panel-group">
										<div class="panel panel-default">
											<div id="headingHoldings" role="tab" class="panel-heading sharesSell" data-toggle="collapse" data-target="#mySellLongShares1" style="cursor: pointer;">
												<p class="panel-title">
													<span>Your Shares:</span><b class="label alert-success label-lg"><?php echo $total_shares; ?></b>
											...
											<div aria-labelledby="mySellLongShares1" role="tabpanel" class="panel-collapse in" id="mySellLongShares12">
												<div class="">
													...
													<table class="table table-striped">
														...
														<?php  foreach($sell_offers as $soffer) { ?>
															<tr>
																...
																<td class="text-center"><span class="off-center-center"><b class="label alert-success label-lg"><?php echo $soffer->unmatched_shares; ?></b></span></td>
