...
<div aria-multiselectable="true" role="tablist" id="accordion_buy" class="panel-group">
		<div class="panel panel-default">
			<div id="headingHoldings" role="tab" class="panel-heading sharesSell" data-toggle="collapse" data-target="#final_sell_yes_new" style="cursor: pointer;">
				<p class="panel-title">
					<span>Your Shares:</span> 
					<a aria-controls="final_sell_yes_new11" aria-expanded="false" href="#final_sell_yes_new" data-parent="#accordion_buy" data-toggle="collapse" class="float-right collapsed">&nbsp; </a>
				</p>
			</div>

			<div aria-labelledby="final_sell_yes_new11" role="tabpanel" class="panel-collapse collapse" id="final_sell_yes_new" style="height: 0px;">
