...
<h4 class="modal-title">Sell No</h4>																	
</div>																	  																	
...
<div class="col-xs-12">	<form id="BuySubmit" method="POST" action >																			     
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#Market_Risk3"><p><span class="pull-left">Decrease In Market Risk(details)</span><span class="pull-right"><?php echo $this->wallet->showBucks($req_bal)	; ?></span></p></a>
                </h4>
            </div>
            <div id="Market_Risk3" class="panel-collapse collapse">
                <div class="panel-body">
                
<p><span class="pull-left">Funds credited to cover your market risk after this trade</span><span class="pull-right"><?php echo $this->wallet->showBucks($req_bal)	; ?></span></p>
...
<p class="light_pink"><span class="pull-left">Maximum Credit </span><span class="pull-right">(<?php echo $this->wallet->showBucks($req_bal)	; ?>)</span></p>
