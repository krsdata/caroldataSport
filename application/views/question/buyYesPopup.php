  ...
  <div id="showBuy">   
	<div id="tradeBuyContent">
		...
		<div class="col-xs-12 col-sm-7">
			<form action="<?php base_url("market/submit_deal"); ?>"  id="BuySubmit" method="post" >
		...
		<div class="col-xs-12 buttons_bottom">
			<div class="float-right">
				<button type="button" class="btn btn-default" onclick="close_jbox()"  id="cancelModal">Cancel</button>
