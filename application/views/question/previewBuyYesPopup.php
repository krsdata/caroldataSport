...
<div class="col-xs-12" class="BuySubmit_jnew">	
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#Market_Risk"><p><span class="pull-left">Increase In Market Risk(details)</span><span class="pull-right"><?php echo $this->wallet->showBucks($req_bal)	; ?></span></p></a>
                </h4>
            </div>
            <div id="Market_Risk" class="panel-collapse collapse">
                <div class="panel-body">
                   <p><span class="pull-left">Funds debited to cover your market risk after this trade</span><span class="pull-right"><?php echo $this->wallet->showBucks($req_bal)	; ?></span></p><br>
<p><span class="pull-left">Current Risk</span><span class="pull-right"><?php echo $this->wallet->showBucks($currentRisk)	; ?></span></p><br>
<p><span class="pull-left">Projected New Risk</span><span class="pull-right"><?php echo $this->wallet->showBucks($projectedRisk)	; ?></span></p><br>
                </div>
            </div>
        </div>
...
<!---<p><span class="pull-left">Increase In Market Risk(details)</span><span class="pull-right"><?php echo $this->wallet->showBucks($req_bal)	; ?></span></p><br>
...
<input type="hidden" name="type" id="type" value="<?php echo $type; ?>" >
								<input type="hidden" name="deal_type" id="deal_type" value="buy" >
...
<div class="pull-left">																				    
<button type="button" class="btn btn-default" id="submitBack">Back</button>
</div>
<div class="float-right">																					
<button type="button" class="btn btn-default" onclick="close_jbox()" id="cancelModal">Cancle</button>
<button type="button" class="btn btn-success" id="submitBuy" >Submit Offer</button>																			
</div>																			
</div></form>
</div>																		
</div>																	
							...
							$.ajax({
								...
								success: function (result) {
									...
									if (result == 'confirm') {
										...
										$.nmManual('<?php echo base_url("market/finalPopup/"); ?>');
