...
<h3 class="h3_green">Open Offer Recorded</h3>
 ...
 <div aria-multiselectable="true" role="tablist" id="accordion_buy" class="panel-group">
		<div class="panel panel-default">
			<div id="headingHoldings" role="tab" class="panel-heading sharesSell" data-toggle="collapse" data-target="#final_sell_no" style="cursor: pointer;">
				<p class="panel-title">
					<span>Your Shares:</span> 
					<a aria-controls="final_sell_no11" aria-expanded="false" href="#final_sell_no" data-parent="#accordion_buy" data-toggle="collapse" class="float-right collapsed">&nbsp; </a>
				</p>
			</div>

			<div aria-labelledby="final_sell_no11" role="tabpanel" class="panel-collapse collapse" id="final_sell_no" style="height: 0px;">
				<div class="final_sell">
					<table class="table table-striped">
						...
						<tbody>
							<tr>
                               <td class="text-left"><?php echo $unmatched ; ?></td>
