...
<div class="modal-header buy_no">																	  
<button type="button" class="close" onclick="close_jbox()">×</button>																	  
<h4 class="modal-title">Buy No</h4>																	
</div>																	  																	
...
<p class="light_pink"><span class="pull-left">Shares</span><span class="pull-right"><?php echo $share_count; ?></span></p><br>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#Market_Risk1"><p><span class="pull-left">Increase In Market Risk(details)</span><span class="pull-right"><?php echo $this->wallet->showBucks($req_bal)	; ?></span></p></a>
                </h4>
            </div>
            <div id="Market_Risk1" class="panel-collapse collapse">
...
<p class="light_pink"><span class="pull-left">Maximum Debit </span><span class="pull-right">(<?php echo $this->wallet->showBucks($req_bal)	; ?>)</span></p><br>
</div>
...
<input type="submit" name="submitBuy" id="submitBuy" value="Submit Offer" class="btn btn-success">
<!--<button type="button" class="btn btn-success" id="submitBuy" >Submit Offer</button>-->																			
</div>
