...
<div style="color:#00CC66;"><?php if($this->session->flashdata('msg') != ''){ echo $this->session->flashdata('msg'); } ?></div>
	...
	<form name="loginForm" class="login-form" action="<?php echo base_url(); ?>user/login" method="post" >
      ...
      <a href="<?php echo base_url(); ?>signup" class="btn btn-success btn-lg btn-block ">Create an Account</a>
		...
		<!-- <a  class="btn-lg btn-block social_login_google_plus" href="<?php echo $login_url;?>"><img src="<?php echo base_url()?>img/login-fb.png" width="180" class="facebook"/></a>
    
		 <a href="<?php echo $authUrl;?>" class="btn-lg btn-block social_login_google_plus"><img src="<?php echo base_url()?>img/login-g.png" width="180" class=""/></a>-->
    </form>
